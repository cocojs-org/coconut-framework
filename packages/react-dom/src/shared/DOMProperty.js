import { hasOwnProperty } from 'react-shared';
...
export function cleanCache() {
    ...
    for (const key of Object.keys(validatedAttributeNameCache)) {
        delete validatedAttributeNameCache[key];
    }
}

const properties = {};

const reservedProps = ['children', 'dangerouslySetInnerHTML', 'defaultValue', 'defaultChecked', 'innerHTML', 'style'];

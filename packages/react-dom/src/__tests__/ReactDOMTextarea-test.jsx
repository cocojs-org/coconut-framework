...
describe('ReactDOMTextarea', () => {
    ...
    it('should allow setting `value` to `giraffe`', () => {
        ...
        stub = cocoMvc.renderIntoContainer(<textarea value="gorilla" onChange={emptyFunction} />, container);
    ...
    it('should allow setting `value` to `true`', () => {
        ...
        stub = cocoMvc.renderIntoContainer(<textarea value={true} onChange={emptyFunction} />, container);
    ...
    it('should allow setting `value` to `false`', () => {
        ...
        stub = cocoMvc.renderIntoContainer(<textarea value={false} onChange={emptyFunction} />, container);
    ...
    it('should allow setting `value` to `objToString`', () => {
        ...
        stub = cocoMvc.renderIntoContainer(<textarea value={objToString} onChange={emptyFunction} />, container);
    ...
    it('should throw when value is set to a Temporal-like object', () => {
        ...
        const test = () =>
            cocoMvc.renderIntoContainer(<textarea value={new TemporalLike()} onChange={emptyFunction} />, container);
    ...
    it('should properly control a value of number `0`', () => {
        const stub = <textarea value={0} onChange={emptyFunction} />;
        const setUntrackedValue = Object.getOwnPropertyDescriptor(HTMLTextAreaElement.prototype, 'value').set;
    ...
    it('should keep value when switching to uncontrolled element if not changed', () => {
        ...
        const node = renderTextarea(<textarea value="kitten" onChange={emptyFunction} />, container);
    ...
    it('should keep value when switching to uncontrolled element if changed', () => {
        ...
        cocoMvc.renderIntoContainer(<textarea value="puppies" onChange={emptyFunction} />, container);
            ...
            render() {
                return (
                    <div>
                        ...
                        <textarea ref={(n) => (node = n)} value="foo" onChange={emptyFunction} />
                    </div>
                );
            }
        }
    ...
    describe('When given a Symbol value', () => {
        it('treats initial Symbol value as an empty string', () => {
            const container = document.createElement('div');
            cocoMvc.renderIntoContainer(<textarea value={Symbol('foobar')} onChange={() => {}} />, container);
            expect(consoleErrorSpy).toHaveBeenCalledWith(
        ...
        it('treats initial Symbol children as an empty string', () => {
            const container = document.createElement('div');
            cocoMvc.renderIntoContainer(<textarea onChange={() => {}}>{Symbol('foo')}</textarea>, container);
            expect(consoleErrorSpy).toHaveBeenCalledWith(
                'Use the `defaultValue` or `value` props instead of setting ' + 'children on <textarea>.'
            );
            const node = container.firstChild;
        ...
        it('treats updated Symbol value as an empty string', () => {
            ...
            cocoMvc.renderIntoContainer(<textarea value={Symbol('foo')} onChange={() => {}} />, container);
            expect(consoleErrorSpy).toHaveBeenCalledWith(
                `Invalid value for prop %s on <%s> tag. Either remove it from the element, or pass a string or number value to keep it in the DOM. For details, see https://reactjs.org/link/attribute-behavior `,
                '`value`',
                'textarea'
    ...
    describe('When given a function value', () => {
        it('treats initial function value as an empty string', () => {
            const container = document.createElement('div');
            cocoMvc.renderIntoContainer(<textarea value={() => {}} onChange={() => {}} />, container);
            expect(consoleErrorSpy).toHaveBeenCalledWith(
                `Invalid value for prop %s on <%s> tag. Either remove it from the element, or pass a string or number value to keep it in the DOM. For details, see https://reactjs.org/link/attribute-behavior `,
                '`value`',
                'textarea'
        ...
        it('treats initial function children as an empty string', () => {
            const container = document.createElement('div');
            cocoMvc.renderIntoContainer(<textarea onChange={() => {}}>{() => {}}</textarea>, container);

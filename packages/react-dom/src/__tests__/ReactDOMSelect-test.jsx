...
describe('ReactDOMSelect', () => {
    ...
    it('should allow setting `defaultValue`', () => {
        ...
        cocoMvc.renderIntoContainer(<select defaultValue="gorilla">{options}</select>, container);
    ...
    it('should allow controlling `value` in a nested render', () => {
        ...
        class Parent {
            ...
            _renderNested = () => {
                cocoMvc.renderIntoContainer(
                    <select onChange={this._handleChange.bind(this)} ref={(n) => (selectNode = n)} value={this.value}>
                        <option value="monkey">A monkey!</option>
                        <option value="giraffe">A giraffe!</option>
                        <option value="gorilla">A gorilla!</option>
                    </select>,
            ...
            const test = () => {
                ReactTestUtils.renderIntoDocument(
                    <select onChange={noop} value="2020-01-01">
                        <option value={new TemporalLike()}>like a Temporal.PlainDate</option>
                        <option value="monkey">A monkey!</option>
                        <option value="giraffe">A giraffe!</option>
                    </select>,
                    cocoMvc

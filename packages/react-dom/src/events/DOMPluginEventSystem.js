...
function executeDispatch(domEvent, listener, currentTarget, reactEventType) {
...
function processDispatchQueueItemsInOrder(domEvent, dispatchListeners, inCapturePhase, reactEventType) {
    if (inCapturePhase) {

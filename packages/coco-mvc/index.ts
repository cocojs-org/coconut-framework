...
export { default as Api } from './src/metadata/api.ts';
export { default as api } from './src/decorator/api.ts';
export { default as Bind } from './src/metadata/bind.ts';
export { default as bind } from './src/decorator/bind.ts';
export { default as Controller } from './src/metadata/controller.ts';
export { default as controller } from './src/decorator/controller.ts';
export { default as GlobalData } from './src/metadata/global-data.ts';
export { default as globalData } from './src/decorator/global-data.ts';
export { default as Layout } from './src/metadata/layout.ts';
export { default as layout } from './src/decorator/layout.ts';
export { default as Page } from './src/metadata/page.ts';
export { default as page } from './src/decorator/page.ts';
export { default as Ref } from './src/metadata/ref.ts';
export { default as ref } from './src/decorator/ref.ts';
export { default as Refs } from './src/metadata/refs.ts';
export { default as refs } from './src/decorator/refs.ts';
export { default as View } from './src/metadata/view.ts';
export { default as view } from './src/decorator/view.ts';
export { default as WebApplication } from './src/metadata/web-application.ts';
